...
await snaplet.Activites([
  {
    ...
    image_path: "/activites/segrada_familia.jpg",
  ...
  },
  {
    ...
    image_path: "/activities/park_guell.jpg",
    done: ({ seed }) => copycat.bool(seed),
    trips_activites: [{ trip: tripsStore.Trips![0].id }],
  },
  {
    ...
    image_path: "/activities/eiffel_tower.jpg",
    done: ({ seed }) => copycat.bool(seed),
  ...
  },
  {
    ...
    image_path: "/activities/louvre_museum.jpg",
    done: ({ seed }) => copycat.bool(seed),
    trips_activites: [{ trip: tripsStore.Trips![1].id }],
  },
  {
    ...
    image_path: "/activities/van_gogh_museum.jpg",
    done: ({ seed }) => copycat.bool(seed),
  ...
  },
  {
    ...
    image_path: "/activities/anne_frank_house.jpg",
    done: ({ seed }) => copycat.bool(seed),
    trips_activites: [{ trip: tripsStore.Trips![2].id }],
  },
]);
