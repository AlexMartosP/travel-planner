...
export function ActivityItem({
  ...
  return (
    <div className="flex justify-between items-center p-2 -ml-2 rounded-md hover:bg-slate-200 transition-all group">
      <Link key={activity.id} href={`/${tripId}/${activity.id}`}>
